...
if (empty($_POST['surname'])) {
 ...
 {$pass = mysqli_real_escape_string($dbcon, ($_POST['password']));}
  ...
  if (@mysqli_num_rows($result) == 0) {
   $q = "INSERT INTO users (user_level, phone_number, email, surname, first_name, other_names, dob, position, username, password, image, reg_date, gender)
 VALUES ('1', '$phone_number', '$email',  '$surname', '$first_name', '$other_name', '$dob', 'clearance officer', '$username', '$pass', '$image', NOW(), '$gender')";
   $result = @mysqli_query ($dbcon, $q);
          ...
          <section class="wrapper">
              ...
              <div class="col-lg-12">
                  <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-plus"></i> Add Clearance officer</h4>
                      <form class="form-horizontal style-form" method="post" action="add-clearanceofficer" enctype="multipart/form-data">
